...
|**Necesidades específicas según el tipo de establecimiento:**|El 33% de los entrevistados son propietarios o administradores de salones de billar, el otro 67% son aficionados al futbol y al billar, este ultimo sugiere una alta representación de este tipo de establecimiento en las entrevistas. Además, el 17% son propietarios de centros de fútbol, otro 17% alquilan canchas de fútbol, y el restante 8% son propietarios de locales de recreación con varias opciones de entretenimiento.|
