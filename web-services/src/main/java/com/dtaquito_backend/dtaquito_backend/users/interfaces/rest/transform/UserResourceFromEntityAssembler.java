...
public class UserResourceFromEntityAssembler {
    ...
    public static UserResource toResourceFromEntity(User entity) {
        return new UserResource(entity.getId(), entity.getName(), entity.getEmail(), entity.getPassword(), entity.getRole().getId(), entity.getRole().getRoleType().name().toUpperCase());
    }
}
